...
import { parseTpbOpenSuccess, parseTpbTransfer } from "../src/server/ocr/banks/tpbank";
 ...
 *   bun scripts/ocr-try.ts tpbank-open --raw anh1.webp     in cả chữ thô Tesseract trả ra
