...
export const BANKS = [
  ...
  // MBV (B9) vào thể lệ từ kỳ 2026-09-16, nhóm hạn chế. Production thêm tay
  // qua P-71 ngày 2026-09-15 với đúng mã này; seed chỉ để dựng database mới.
  { code: "MBV", requiredPhotos: 4, accountNumberMethod: "phone-match", coefficient: "1", countsAsApp: true },
