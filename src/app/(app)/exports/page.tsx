  ...
  switch (report) {
    ...
    case "staff-points":
      return [
        ...
        { key: "bankingPoints", header: "Điểm ngân hàng", type: "number", defaultOn: true, sample: ["85", "60"], value: (r) => r.bankingPoints },
        { key: "servicePoints", header: "Điểm dịch vụ", type: "number", defaultOn: true, sample: ["25", "15"], value: (r) => r.servicePoints },
        { key: "totalPoints", header: "Tổng điểm", type: "number", defaultOn: true, sample: ["110", "75"], value: (r) => totalPoints(r) },
    ...
    case "insurance-by-month":
      return [
        ...
        { key: "date", header: "Ngày", defaultOn: true, sample: ["15/07/2026", "20/07/2026"], value: (r) => r.date },
