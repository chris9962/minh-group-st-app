 ...
 *
 * Khách, ngân hàng và LOẠI tài khoản KHÔNG sửa được ở cả hai mặt: đổi chúng là
 * viết lại lịch sử kho mã, không phải sửa một chỗ gõ nhầm. Loại cố định từ mã
 * giới thiệu chọn lúc giữ chỗ (chốt 2026-09-06); muốn loại khác thì mở dòng
